...
hyfilespath = '/Volumes/500gb/hy_data/NN_nofluor/'
# path to where new HE txt files will go with fluorescence added
newpath = '/Volumes/500gb/hy_data/NN_fluor/txt/'
...
#----------
fqyList = [0.0025,0.005,0.01,0.015]
...
##
    #fname = 'M4.58_0.0_24_0.302_0.337_15.txt'
    import pandas as pd
    import numpy as np
...
##
    ...
    if cy != 'nan':
        ...
        newfname = 'M' + '_'.join(info) + '_nan_{0}.txt'.format(fqy)
    #
