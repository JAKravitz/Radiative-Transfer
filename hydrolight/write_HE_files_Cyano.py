...
# chl
sigma,scale = lognorm_params(5,1000)
chlaData = lognorm_random(sigma, scale, 100000)
chlaData = chlaData[chlaData<20000]

# admix
admix0 = np.array([0])
admix1 = np.arange(0,1.1,.1)
admix2 = np.array([0,.2,.3,.4,.5,.6,.7,.8,.9,1])
admix3 = np.array([0,.4,.5,.6,.7,.8,.9,1])
admix4 = np.array([0,.6,.7,.8,.9,1])
admix5 = np.array([0,.8,.9,1])
admix6 = np.array([0,1])
admix7 = np.array([1])
...
cnapData = lognorm_random(sigma,scale, 40000)

# cdom
sigma, scale = lognorm_params(1, 1)
acdomData = lognorm_random(sigma, scale, 30000)
