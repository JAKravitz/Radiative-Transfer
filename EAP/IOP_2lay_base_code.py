...
astarpath = '/Users/jkravz311/Desktop/nasa_npp/groundtruth_data/phyto_optics/in_vivo_phyto_abs.csv'
# effective diameter
Deff = np.arange(5,15,1)
# relative chloroplast volume
Vs1 = [0.05, 0.1, 0.15, 0.2, 0.25] # smaller phytos
Vs2 = [0.2, 0.25, 0.3, 0.35, 0.4] # medium phytos
Vs3 = [0.35, 0.4, 0.45, 0.5, 0.55, 0.6] # large phytos
# intracellular chl density mg/m-3
ci = 2.5e6
# real refractive index
nshell = 1.14 # outer shell
ncore = 1.02 # core

#%%
def params (phyto, mf, astarpath, Vs, ci, Deff, nshell, ncore):
...
Qc, Sigma_c, c, Qb, Sigma_b, b, Qa, Sigma_a, a, Qbb, Sigma_bb, bb, bbtilde = params(phyto, mf, astarpath, Vs, ci, Deff, nshell, ncore)

optics[Class][phyto] = {'a':a,
                        'b':b,
                        'c':c}
